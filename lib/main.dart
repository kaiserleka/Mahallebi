...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Mahallebi'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget displaySideMenu(String side) {
    ...
    if (side == "left") {
      ...
      switch (curAddress.areaType) {
        case "streetView":
          print(": " + (curAddress.streetNo).toString());
  ...
  Widget displayPanel() {
    ...
    for (var i = 0; i < gameItemList.length; i++) {
      Color curColor = (gameItemList[i].isFound == false)
          ? Colors.black26
          : Colors.indigo[700];
      var curIcon = Icon(
        gameItemList[i].icon,
                  ...
                  child: (hasGameItem == false)
                      ...
                      : GestureDetector(
                          child: Container(
                            ...
                            child: Icon(
                              gameItemList[curRoom.gameItemNo].icon,
  ...
  Widget showTasks() {
    ...
    for (var i = 0; i < taskList.length; i++) {
      taskListWidgets.add(Container(
          padding: EdgeInsets.all(10), child: showTaskItem(taskList[i])));
    }
    return SingleChildScrollView(
      child: Container(
          padding: EdgeInsets.all(10),
